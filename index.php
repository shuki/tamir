...
<body>
	...
	<div id="tabs">
		<ul>
			...
			<?php if($user_group <= 3){ ?><li><a href="#tabs-9">דוחות</a></li><?php } ?>
			<?php if($user_group == 1) jset_payment::payment_li($jset_payment); ?>
			</ul>
		<?php if($user_group != 4){ ?>
		<div style="width:100%; margin-top:10px; text-align: center" id="tabs-0">
			<h1 style="color:green;">מערכת תמיר</h1>
			<img src="<?php echo $dir_pre ?>jset/img/jxset.jpg"/>
			<div>תמיכה: <a href="mailto:shukrun.shuki@gmail.com?Subject=מערכת%20תמיר" target="_blank">shukrun.shuki@gmail.com</a></div>
		</div>
		<div id="tabs-1">
